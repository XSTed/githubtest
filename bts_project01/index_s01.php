            ...
            <div class="row">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">隔離/防曬/飾底乳</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">BB霜/CC霜</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">粉餅(蕊)/蜜粉/蜜粉/海綿</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">遮瑕/毛孔/打亮</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">天然成分調理專區</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">婦嬰,敏感受損調理</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">Neogen</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">萊雅</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">肌研</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">露得清</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">按摩油</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">纖體保養</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">身體香氛</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">身體防曬</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">肝臟保養／芝麻素</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">益生菌／乳酸菌</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">鐵／葉酸／孕期補充</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">蔓越莓／女性保養</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">男性健康補充</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">銀髮健康補充</a></td>
                                            </tr>
                                            <tr>
                                                <td><em class="fas fa-edit"></em><a href="#">成人特殊營養品</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                ...
                <div class="col-md-10">
                    ...
                    <div class="row text-center mb-3">
                        ...
                        <div class="card col-md-3">
                            <img src="product_img/pic0103.jpg" class="card-img-top" alt="森下仁丹整晚貼眼膜">
                            <div class="card-body">
                        ...
                        <div class="card col-md-3">
                            <img src="product_img/pic0104.jpg" class="card-img-top" alt="【美爽爽】泡泡染">
                            <div class="card-body">
