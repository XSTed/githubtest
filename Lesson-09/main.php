...
<body>
    <section id="header">
        <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="index.html"><!-- <i class="fas fa-home" aria-hidden="true" style="color:#FF000F;font-size:40px;margin-top:-5px;margin-left:10px;"></i> -->
            </a>
          ...
          <a class="nav-link active" aria-current="page" href="#">Home</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="index.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="images/lincanLogo.png" alt="LOGO" class="img-fluid">
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#production" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">站長推薦
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container-fluid">
            ...
            <div class="row text-center">
                <div class="jumbotron">
                    ...
                    <p>林肯運動鞋專賣店-電子商店</p>
                    <a href="#" class="btn btn-primary btn-lg" role="button">Show More</a>
                </div>
            </div>
    </section>
    <hr>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="card col-md-4">
                    <img src="images/pic61.jpg" alt="adidas 休閒慢跑鞋">
                    <div class="card-body">
                        <h5>adidas 休閒慢跑鞋</h5>
                        <p>Loop Racer 全黑 復古 運動鞋 男鞋 女鞋 B42446，愛迪達 Originals 三葉草 輕量透氣舒適運動球鞋穿搭推薦,男女款情侶鞋</p>
                        <p>NT2500</p>
                ...
                <div class="card col-md-4">
                    <img src="images/pic62.jpg" alt="Reebok 休閒慢跑鞋">
                    <div class="card-body">
                        <h5>Reebok 休閒慢跑鞋</h5>
                        <p>Reebok Insta Pump Fury SP 藍 灰 麂皮 潑漆 雪花 休閒鞋 男鞋 平底鞋 休閒鞋 慢跑鞋 球鞋 情侶運動鞋 ..............</p>
                        <p>NT4580</p>
                        <a href="#" class="btn btn-primary">更多資訊</a>
                        <a href="#" class="btn btn-success">放購物車</a>
                    </div>
                ...
                <div class="card col-md-4">
                    <img src="images/pic63.jpg" alt="Nike 阿甘鞋">
                    <div class="card-body">
                        <h5>Nike 阿甘鞋</h5>
                        <p>Wmns Classic Cortez Leather 復古慢跑鞋 白藍紅 OG 原版配色 女鞋 漢娜妞 松本惠奈 女孩球鞋穿搭推薦款式 百搭熱銷款 皮面不容易髒</p>
                        <p>NT3380</p>
                        <a href="#" class="btn btn-primary">更多資訊</a>
                        <a href="#" class="btn btn-success">放購物車</a>
                    </div>
                ...
                <div class="card col-md-4">
                    <img src="images/pic64.jpg" alt="Puma 慢跑鞋">
                    <div class="card-body">
                        <h5>Puma 慢跑鞋</h5>
                        <p>Speed 600 Ignite Pwrcool Wn 黃銀 運動 女鞋 188521-02 Running 超輕量透氣 低筒 跑步健身訓練推薦鞋款</p>
                        <p>NT2880</p>
                        <a href="#" class="btn btn-primary">更多資訊</a>
                        <a href="#" class="btn btn-success">放購物車</a>
                    </div>
                ...
                <div class="card col-md-4">
                    <img src="images/pic65.jpg" alt="Asics 慢跑">
                    <div class="card-body">
                        <h5>Asics 慢跑鞋</h5>
                        <p>競速跑鞋 Tartherzeal 4 藍 橘 白底 男鞋 輕量 運動鞋 TJR282-5230 Racing 低筒 虎走 馬拉松 路跑推薦款式 特殊專業跑鞋設計</p>
                        <p>NT3490</p>
                        <a href="#" class="btn btn-primary">更多資訊</a>
                        <a href="#" class="btn btn-success">放購物車</a>
                    </div>
                ...
                <div class="card col-md-4">
                    <img src="images/pic66.jpg" alt="美津濃 Mizuno Prophecy 5">
                    <div class="card-body">
                        <h5>美津濃 Mizuno Prophecy 5</h5>
                        <p>美津濃 Mizuno Prophecy 5藍黃 彈簧 慢跑鞋 男鞋 J1GC16-0047 Running U4ic中底材質,X10耐磨INFINITY WAVE大底</p>
                        <p>NT5080</p>
                        <a href="#" class="btn btn-primary">更多資訊</a>
                        <a href="#" class="btn btn-success">放購物車</a>
                    </div>
    ...
    <section id="sportlogo">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3"><img src="images/pic72.jpg" alt="Reebok" class="img-fluid" title="Reebok"></div>
                <div class="col-sm-3"><img src="images/pic73.jpg" alt="Mizuno" class="img-fluid" title="Mizuno"></div>
                <div class="col-sm-3"><img src="images/pic74.jpg" alt="Nike" class="img-fluid" title="Nike"></div>
            </div>
            <div class="row">
                <div class="col-sm-3"><img src="images/pic75.jpg" alt="Kappa" class="img-fluid" title="Kappa"></div>
                <div class="col-sm-3"><img src="images/pic76.jpg" alt="PUMA" class="img-fluid" title="PUMA"></div>
                <div class="col-sm-3"><img src="images/pic77.jpg" alt="CONVERSE" class="img-fluid" title="CONVERSE"></div>
                <div class="col-sm-3"><img src="images/pic78.jpg" alt="SPRIT" class="img-fluid" title="SPRIT"></div>
            </div>
        </div>
    </section>
    <hr>
    ...
    <section id="buyrules" class="bgcolor">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <h4>付款方式</h4>
                <p>★超商付款取貨，超商取貨時付款，全家繳費不取貨，適用無卡片轉帳且需宅配取件的顧客，線上刷卡，信用卡一次付清。</p>
            ...
            <div class="col-sm-2">
                <h2><i class="far fa-address-card" aria-hidden="true"></i> </h2>
                <h4>退換貨說明</h4>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 offset-2">
                    <form action="main.php" method="post" name="form1" id="form1">
                        ...
                        <div class="row form-group"><input type="text" class="form-control" name="cname" id="cname" placeholder="Name" required>
                        </div>
                        <br>

                        <div class="row form-group"><input type="number" class="form-control" name="tel" id="tel" placeholder="TEL" required>
                        </div>
                        <br>
                        <!-- form-group5版以後可以省略 -->
                        <div class="row form-group"><input type="email" class="form-control" name="email" id="email" placeholder="Email" required>
                        </div>
                        <br>

                        <div class="row form-group"><input type="text" class="form-control" name="address" id="address" placeholder="Address" required>
                        </div>
                        <br>

                        <div class="row form-group"><textarea row="6" class="form-control" name="message" id="message" placeholder="Message"></textarea>
