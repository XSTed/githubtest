    ...
    <div align="center">
        <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
            <table width="900" border="1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td height="40" align="center" valign="middle">出生日期</td>
